            ...
            <div class="row">
                ...
                <div class="span2 " id="loginbox">
                    ...
                    <form class="form-horizontal" method="post" action="emhome.php">
                        ...
                        <div class="control-group">
                          <label class="control-label" for="inputEmail">ชื่อ,เลขที่ประจำตัวประชาชน,รหัสใบสมัคร</label>
                          <div class="controls">
                            <input type="text" id="inputEmail" placeholder="ชื่อ,เลขที่ประจำตัวประชาชน,รหัสใบสมัคร">
                          </div>
                        </div>
                        <div class="control-group">
                          <div class="controls">
